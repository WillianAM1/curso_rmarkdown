...
\hypertarget{customizauxe7uxe3o}{%
\chapter{Customização}\label{customizauxe7uxe3o}}
...
\section{Tipos de documentos}\label{tipos-de-documentos}}

\hypertarget{apresentauxe7uxe3o-de-slides}{%
\subsection{Apresentação de slides}\label{apresentauxe7uxe3o-de-slides}}
...
\subsubsection{Opções de preâmbulo:}\label{opuxe7uxf5es-de-preuxe2mbulo}}
...
\subsubsection{Opções de customização}\label{opuxe7uxf5es-de-customizauxe7uxe3o}}

tabsection

\hypertarget{exemplo-com-tabset}{%
\paragraph{Exemplo com tabset}\label{exemplo-com-tabset}}

\hypertarget{aba-1}{%
\paragraph{Aba 1}\label{aba-1}}

Conteúdo da aba 1

\hypertarget{aba-2}{%
\paragraph{Aba 2}\label{aba-2}}
