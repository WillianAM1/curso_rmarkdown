...
[](Executando código/Imagem 1.png)

Quando quiser executar um código em blocos, utilize ..., antes e depois do código. Exemplo:
[](Executando código/Imagem 2.png) [](Executando código/Imagem 2.1.png)

Algumas opções básicas dos blocos de código:
[](Executando código/Imagem 3.png)
[](Executando código/Imagem 3.1.png)

Para inserir figuras em blocos de código:
[](Executando código/Imagem 4.png)
[](Executando código/Imagem 4.1.png)

Para inserir tabelas:
[](Executando código/Imagem 5.png)
[](Executando código/Imagem 5.1.png)
